...
class INTEGER(Nodo):
	...
	def imprimir(self,ident):
		print (ident+"INTEGER: "+str(self.name))
...
class DOUBLE(Nodo):
	...
	def imprimir(self,ident):
		print (ident+"DOUBLE: "+str(self.name))
...
class FLOAT(Nodo):
	...
	def imprimir(self,ident):
		print (ident+"FLOAT: "+str(self.name))
...
class CHARACTER(Nodo):
	def __init__(self,name):
		self.name = name

	def imprimir(self,ident):
		print (ident+"CHARACTER: "+str(self.name))
...
class BOOLEAN(Nodo):
	...
	def imprimir(self,ident):
		print (ident+"BOOLEAN: "+str(self.name))
